...
public enum EtatAnoRTC
{
    ...
    EtatAnoRTC(String valeur, String action)
    {
        this.valeur = valeur;
        this.action = action;
    }
    ...
    public static EtatAnoRTC from(String valeur)
    {
        if (valeur == null || valeur.isEmpty())
            throw new IllegalArgumentException("model.enums.EtatAnoRTC.from - état envoyé nul ou vide.", null);
        ...
        switch (valeur)
        {
            ...
            default:
                throw new IllegalArgumentException("model.enums.EtatAnoRTC.from - état envoyé inconnu : " + valeur, null);
        }
    }
    /*---------- METHODES PRIVEES ----------*/
    /*---------- ACCESSEURS ----------*/
    ...
    private static final class Valeur
    {
        ...
        private static final String NOUVELLE2 = "1.Nouvelle";
