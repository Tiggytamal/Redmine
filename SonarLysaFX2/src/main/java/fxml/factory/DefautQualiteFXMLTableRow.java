...
public class DefautQualiteFXMLTableRow extends FXMLTableRow<DefautQualiteFXML, String, ActionDq, Dao<DefautQualite, String>, DefautQualite, DefautQualiteBDD>
{
    /*---------- ATTRIBUTS ----------*/
    ...
    // Liste des actions possibles non gérées par l'énumération
    private MenuItem modifItem;

    /*---------- CONSTRUCTEURS ----------*/

    public DefautQualiteFXMLTableRow(DefautQualiteBDD control, Dao<DefautQualite, String> dao)
    {
        super(dao, control, ActionDq.values());

        modifItem = new MenuItem("Modifier Remarques");
        ...
        creerMenu(a -> new TraiterActionDefautQualiteTask(a, dao.recupEltParIndex(getItem().getIndex())));
    }
    /*---------- METHODES PUBLIQUES ----------*/
