...
public class TestEtatAnoRTC implements TestEnums
{
    ...
    public void testFrom()
    {
        ...
        assertEquals(EtatAnoRTC.REJETEE, EtatAnoRTC.from("Rejetée"));
        assertEquals("Rejetée", EtatAnoRTC.REJETEE.getValeur());
        assertEquals(EtatAnoRTC.EDITEUR, EtatAnoRTC.from("Correctif éditeur testé"));
        assertEquals("Correctif éditeur testé", EtatAnoRTC.EDITEUR.getValeur());
        assertEquals(EtatAnoRTC.ATTEDITEUR, EtatAnoRTC.from("En attente correctif éditeur"));
        assertEquals("En attente correctif éditeur", EtatAnoRTC.ATTEDITEUR.getValeur());
        assertEquals(EtatAnoRTC.DENOUEMENT, EtatAnoRTC.from("En attente de dénouement"));
        assertEquals("En attente de dénouement", EtatAnoRTC.DENOUEMENT.getValeur());
        assertEquals(EtatAnoRTC.ABANDONNEE, EtatAnoRTC.from("Abandonnée"));
        assertEquals("Abandonnée", EtatAnoRTC.ABANDONNEE.getValeur());
        ...
        listeException.add("\0Rejetée");
        listeException.add("\0En attente de dénouement");
        listeException.add("\0Abandonnée");
        listeException.add("\0En attente correctif éditeur");
        listeException.add("\0Correctif éditeur testé");
