...
public class TestControlMail extends JunitBase
{
    ...
    {
        // Appel de la méthode
        Message message = handler.envoyerMail(TypeMail.SUIVIJAVA);
    ...
    public void testAddExtra()
    {
        ...
        assertTrue(Pattern.compile(extra + "$").matcher(getTexteMail(message)).find());
    }
     ...
     */
    private String getTexteMail(Message message)
    {
        try
        {
